            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa  fa-list fa-fw"></i> Registrasi Permohonan</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="row">
                    <div class="col-lg-12">
						...
						<button class="btn btn-danger" onclick="add_workplans()"><i class="glyphicon glyphicon-plus"></i> Tambah</button><br /><br />
