        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url()?>" class="site_title"><i class="fa fa-users"></i> <span>SIMPERS</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li><a href="<?php echo base_url('')?>"><i class="fa fa-home"></i> Home <span class="fa"></span></a></li>
                    <li><a><i class="fa fa-table"></i> Master Data <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="<?php echo base_url('master/page/pegawai')?>">Data Karyawan</a></li>
                            <li><a href="<?php echo base_url('master/page/tunjangan')?>">Data Tunjangan</a></li>
                            <li><a href="<?php echo base_url('master/page/kj')?>">Data Merit</a></li>
                            <li><a href="<?php echo base_url('master/page/nomenklatur')?>">Data Nomenklatur</a></li>
                            <li><a href="<?php echo base_url('master/page/jenisdiklat')?>">Data Jenis Diklat</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-database"></i> Data Kepegawaian <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="<?php echo base_url('master/page/keluarga')?>">Hubungan Keluarga Karyawan</a></li>
                            <li><a href="<?php echo base_url('master/page/pendidikan')?>">Riwayat Pendidikan Formal Karyawan</a></li>
                            <li><a href="<?php echo base_url('master/page/jabatan')?>">Riwayat Jabatan Karyawan</a></li>
                            <li><a href="<?php echo base_url('master/page/diklat')?>">Riwayat Diklat Karyawan</a></li>
                        </ul>
                    </li>
                </ul>
              </div>
