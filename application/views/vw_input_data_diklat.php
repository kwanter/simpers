...
<div class="right_col" role="main">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form id="form-input" data-parsley-validate="" action="<?php echo base_url('diklat/addData')?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-8">
                        <input id="tgl_diklat" name="tgl_diklat" required="required" class="form-control col-md-5 col-xs-8" type="text">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-2 col-xs-12">
                        <input id="tema_diklat" name="tema_diklat" required="required" class="form-control col-md-4 col-xs-12" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label for="lokasi" class="control-label col-md-3 col-sm-3 col-xs-12">Penyelenggara</label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <input id="lokasi" name="lokasi" required="required" class="form-control col-md-7 col-xs-12" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label for="penyelenggara" class="control-label col-md-3 col-sm-3 col-xs-12">Penyelenggara</label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <input id="penyelenggara" name="penyelenggara" required="required" class="form-control col-md-7 col-xs-12" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label for="tgl_lulus" class="control-label col-md-3 col-sm-3 col-xs-12">No Sertifikat</label>
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <input id="no_sertifikat" name="no_sertifikat" required="required" class="form-control col-md-4 col-xs-12" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nilai" class="control-label col-md-3 col-sm-3 col-xs-12">Nilai</label>
                    <div class="col-md-1 col-sm-4 col-xs-12">
                        <input id="nilai" name="nilai" class="form-control col-md-7 col-xs-12" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label for="skala_nilai" class="control-label col-md-3 col-sm-3 col-xs-12">Skala Nilai</label>
                    <div class="col-md-1 col-sm-4 col-xs-12">
                        <input id="skala_nilai" name="skala_nilai" class="form-control col-md-7 col-xs-12" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label for="sertifikat" class="control-label col-md-3 col-sm-3 col-xs-12">Sertifikat</label>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <input id="sertifikat" data-show-errors="true" class="dropify form-control col-md-7 col-xs-12" name="sertifikat" type="file">
                    </div>
                </div>
