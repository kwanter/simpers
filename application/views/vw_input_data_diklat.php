...
<div class="right_col" role="main">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form id="form-input" data-parsley-validate="" action="<?php echo base_url('diklat/addData')?>" method="POST" class="form-horizontal form-label-left" novalidate="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <input id="penyelenggaraa" name="penyelenggara" required="required" class="form-control col-md-7 col-xs-12" type="text">
                    </div>
                </div>
                <div class="form-group">
