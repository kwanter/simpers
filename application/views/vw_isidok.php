            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Input Informasi Dokumen</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="row">
                    <div class="col-lg-12">
						...
						<a href="<?php echo base_url().'permohonan'; ?>" class="btn btn-success" ><i class="fa fa-backward"></i> Kembali</a><br /><br />
							<table style="font-weight:bold;" border="0" width="100%">
								...
								<tr valign="top">
									...
									<td align='right'>
										...
										<?php if($numstat==2){ ?>
										<a onclick='submitdok(this.id)' class='btn btn-primary btn-sm' title='Submit Permohonan' id="<?php echo $id; ?>">Submit</a>
...
$(document).ready(function() {
	...
	table = $('#table').DataTable({
		...
		"ajax": {
            url : "<?php echo base_url().'isidok/ajax_list/'.$id; ?>",
            type : 'GET'
        },
...
function submitdok(id)
{
    if(confirm('Yakin submit permohonan pembayaran ?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('permohonan/ajax_submitdok')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                //reload_table();
				if(data.status)
					window.location = "<?php echo base_url().'permohonan';?>";
				alert(data.info);
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
                alert('Submit permohonan gagal');
            }
        });
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <input name="nodok" class="form-control" type="text" placeholder="Nomor Dokumen">
								<span class="help-block"></span>
                            </div>
                        </div>
