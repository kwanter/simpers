            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa  fa-calendar-check-o fa-fw"></i> Verifikasi Permohonan</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
...
$(document).ready(function() {
	...
	table = $('#table').DataTable({
		...
		"ajax": {
            url : "<?php echo base_url().'permohonan/ajax_list2'; ?>",
            type : 'GET'
        },
		 /*"columnDefs": [
...
function cancel(id)
{
    if(confirm('Yakin akan menolak permohonan ini ?'))
    {
        // ajax delete data to database
        $.ajax({
