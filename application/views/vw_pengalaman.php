            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-cubes fa-fw"></i> Riwayat Pengalaman Karyawan</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-warning">
                            <div class="panel-heading">
                                Daftar Riwayat Pengalaman Karyawan
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
...
$(document).ready(function() {
	...
	table = $('#table').DataTable({
		...
		"ajax": {
            url : "<?php echo base_url().'pengalaman/ajax_list/'.$id; ?>",
            type : 'GET'
        },
		 /*"columnDefs": [
...
function add()
{
	...
	$("#tgl2").datepicker().datepicker("setDate", new Date());
}
...
function edit(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('pengalaman/ajax_edit/')?>" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {		
            $('[name="id"]').val(data[0].id_rwpengalaman);
			$('[name="nama"]').val(data[0].nama_tempat);
			$('[name="kota"]').val(data[0].kota);
			$("#tgl").datepicker().datepicker("setDate", new Date(data[0].tgl_mulai));
			$("#tgl2").datepicker().datepicker("setDate", new Date(data[0].tgl_selesai));
...
function deldata(id)
{
    if(confirm('Yakin ingin menghapus data ini ?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('pengalaman/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('pengalaman/ajax_add/'.$id);?>";
    } else {
        url = "<?php echo site_url('pengalaman/ajax_update/'.$id);?>";
    }
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9">
								<input name="nama" type="text" class="form-control" id="nama" placeholder="Nama Tempat">
						...
						<div class="form-group">
							<label class="control-label col-md-3">Tgl Mulai</label>
							<div class="col-md-9">
						...
						<div class="form-group">
							<label class="control-label col-md-3">Tgl Selesai</label>
							<div class="col-md-9">
								<input type="text" class="form-control pull-right" id="tgl2" readonly="readonly">
								<span class="help-block"></span>
							</div>
						</div>
