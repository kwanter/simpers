            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Daftar Dokumen Validasi</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
							...
							<table style="font-weight:bold;" border="0" width="100%">
								...
								<tr valign="top">
									...
									<td align='right'>
										...
										<a onclick='submitvalid(this.id)' class='btn btn-primary btn-sm' title='Submit Validasi' id="<?php echo $id; ?>">Submit</a>
										<?php }?>
									</td>
								</tr>
							</table>
						...
						<div class="panel panel-danger">
                            ...
                            <div class="panel-heading">
                                Daftar Dokumen Yang Divalidasi
                            </div>
                            <!-- /.panel-heading -->
...
$(document).ready(function() {
	...
	table = $('#table').DataTable({
		...
		"ajax": {
            url : "<?php echo base_url().'isidok/ajax_list3/'.$id; ?>",
            type : 'GET'
        },
...
function save()
{
    ...
    if(save_method == 'add') {
        ...
        url = "<?php echo site_url('isidok/ajax_update2')?>";
    }
...
{
    if(confirm('Yakin akan submit hasil validasi ?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('permohonan/ajax_submitvalid')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
{
    if(confirm('Yakin ingin reset catatan ?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('isidok/ajax_resetnote')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nodok" class="form-control" type="text" readonly="readonly">
								<span class="help-block"></span>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="notes" class="form-control" type="text" placeholder="Catatan Koreksi">
								<span class="help-block"></span>
                            </div>
                        </div>
